class AutomationDashboardManager {
    ...
    async executeAutomation() {
        ...
        // Show result section
        const resultSection = document.getElementById('automation-result');
        if (resultSection) {
        ...
        try {
            ...
            if (response.ok) {
                this.showAutomationResult(result);
                this.showSuccess('Automação executada com sucesso!');
            } else {
                console.error('Automation error:', result);
                this.showError(result.error || 'Erro na execução da automação');
            }
        } catch (error) {
    ...
    showProgressIndicator() {
        ...
        automationLog.innerHTML = progressContent;
    }
    ...
    showAutomationResult(result) {
        ...
        const logContent = `
            ...
            <div class="text-blue-600 dark:text-blue-400">
                ...
                CPF: ${result.cpf || this.extractedCPF}
            </div>
            <div class="text-blue-600 dark:text-blue-400">
                <i class="fas fa-info-circle mr-2"></i>
            ...
            <div class="text-blue-600 dark:text-blue-400">
                <i class="fas fa-info-circle mr-2"></i>
                Tipo de Plano: ${result.tipo_plano || 'N/A'}
            </div>
            <div class="text-blue-600 dark:text-blue-400">
                <i class="fas fa-info-circle mr-2"></i>
                Coparticipação: ${result.coparticipacao || 'N/A'}%
            </div>
            <div class="text-blue-600 dark:text-blue-400">
                <i class="fas fa-info-circle mr-2"></i>
                Porte da Empresa: ${result.porte_empresa || 'N/A'}
            </div>
            <div class="text-green-600 dark:text-green-400">
                <i class="fas fa-check-circle mr-2"></i>
                Documentos processados: ${result.documentos_count || this.documents.length}
            </div>
            <div class="text-yellow-600 dark:text-yellow-400">
                <i class="fas fa-clock mr-2"></i>
                Tempo de execução: ${result.tempo_execucao || 'N/A'}
            </div>
            <div class="text-green-600 dark:text-green-400">
                <i class="fas fa-check-circle mr-2"></i>
        ...
        automationLog.innerHTML = logContent;
    }
