...
class DashboardManager {
    ...
    createMonthlySalesChart() {
        const options = {
            series: [{
                name: 'Vendas',
                data: [65, 78, 90, 85, 95, 88, 92, 85, 78, 82, 88, 95]
            }],
            chart: {
                type: 'bar',
                height: 250,
        ...
        this.charts.monthlySales = new ApexCharts(document.querySelector("#monthly-sales-chart"), options);
        this.charts.monthlySales.render();
    }

    createOCRSuccessChart() {
        const options = {
            series: [85, 15],
            chart: {
                type: 'donut',
        ...
        this.charts.ocrSuccess = new ApexCharts(document.querySelector("#ocr-success-chart"), options);
        this.charts.ocrSuccess.render();
    }
    ...
    createPerformanceChart() {
        ...
        this.charts.performance = new ApexCharts(document.querySelector("#performance-chart"), options);
    ...
    updateCharts(newData) {
        if (this.charts.monthlySales) {
            this.charts.monthlySales.updateSeries([{
                name: 'Vendas',
                data: newData.monthlySales || [65, 78, 90, 85, 95, 88, 92, 85, 78, 82, 88, 95]
            }]);
        }

        if (this.charts.ocrSuccess) {
            this.charts.ocrSuccess.updateSeries(newData.ocrSuccess || [85, 15]);
        }

        if (this.charts.performance) {
            this.charts.performance.updateSeries([{
                name: 'Performance',
                data: newData.performance || [30, 40, 35, 50, 49, 60, 70, 91, 125, 150, 180, 200]
            }]);
        }
    }
    ...
    refreshData() {
        ...
        setTimeout(() => {
            const newData = {
                monthlySales: [70, 82, 95, 90, 100, 93, 97, 90, 83, 87, 93, 100],
                ocrSuccess: [88, 12],
                performance: [35, 45, 40, 55, 54, 65, 75, 96, 130, 155, 185, 205]
            };
